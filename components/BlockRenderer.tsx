...
const BlockRenderer: React.FC<BlockRendererProps> = ({ block }) => {
  ...
  switch (block.__typename) {
    ...
    case "ComponentBlocksBannerContent":
      return <BannerContentBlockComponent block={block as BannerContentBlock} />;
    ...
    case "ComponentBlocksIndustryParticipants":
      return <IndustryParticipantsBlock block={block as IndustryParticipantsBlockData} />;
    ...
    case "ComponentBlocksSolutionsContentSlider":
      return <SolutionsContentSlider block={block as SolutionsContentSliderBlock} />;

    case "ComponentBlocksStickySubMenu":
      return <StickySubMenu block={block as StickySubMenuBlock} />;
   case "ComponentBlocksOurSolutions":
      return <SolutionsSection block={block as OurSolutionsBlock} />;
    case "ComponentBlocksOurSolutions":
    ...
    case "ComponentBlocksPromotionalBannerCta":
      return <PromotionalBannerCta block={block as PromotionalBannerCtaBlock} />;

    case "ComponentBlocksPostContent2ColumnLayout":
      return <PostContent2ColumnLayout block={block as PostContent2ColumnLayoutBlock} />;

    case "ComponentBlocksPostContent4ColumnLayout":
      return <PostContent4ColumnLayout block={block as PostContent4ColumnLayoutBlock} />;
    ...
    case "ComponentBlocksImageAndTextClickable":
      return <ImageAndTextClickableBlockComponent block={block as ImageAndTextClickableBlock} />;
    ...
    case "ComponentBlocksOverviewHeadingAndContent":
      return <OverviewHeadingAndContent block={block as OverviewHeadingAndContentBlock} />;

    case "ComponentBlocksQuotesAndContents":
      return <QuotesAndContentsBlockComponent block={block as QuotesAndContentsBlock} />;
