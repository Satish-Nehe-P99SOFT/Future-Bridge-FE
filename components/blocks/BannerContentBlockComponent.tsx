...
const BannerContentBlockComponent: React.FC<BannerContentBlockProps> = ({ block }) => {
  ...
  if (pathname?.includes("/industry/")) {
    if (pathname.includes("chemicals") || block.heading?.includes("Chemicals")) {
      imageUrl = "/images/Chemicals-banner.png";
    } else if (pathname.includes("energy") || block.heading?.includes("Energy")) {
    ...
    } else if (pathname.includes("home-and-personal-care") || block.heading?.includes("Home")) {
      imageUrl = "/images/Home-and-personal-care-banner.jpg";
    } else if (pathname.includes("life-sciences") || block.heading?.includes("Life Sciences")) {
      imageUrl = "/images/life-sciences-banner.png";
    } else if (pathname.includes("industrial-equipment") || block.heading?.includes("Industrial")) {
      imageUrl = "/images/industrial-equipment-banner.png";
    } else if (pathname.includes("mobility") || block.heading?.includes("Mobility")) {
    ...
    <div className="relative py-40 text-center text-white">
      {imageUrl && (
        <Image
          src={imageUrl}
          alt={
            block.background?.data?.attributes?.alternativeText || block.heading || "Banner image"
          }
          fill
