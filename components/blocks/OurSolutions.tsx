          ...
          <div className="hidden md:block md:w-48 lg:w-56 shrink-0 relative">
            ...
            <div className="bg-gray-700 rounded-lg shadow-lg overflow-hidden h-full flex flex-col">
              <div className="py-6 px-4 text-center">
                <h3 className="text-xl font-semibold text-white mb-2">Future of</h3>
              </div>
                ...
                futureOfColum.futureOfIcons.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Caption */}
                      <span className="text-base text-white font-medium">{item.iconCaption}</span>
                    </div>
                  );
                })}
            </div>
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  bottom: `calc(${3 * (ourSolutionDescription?.length || 1 - 1)}rem + 1.25rem)`,
                }}
              ></div>
