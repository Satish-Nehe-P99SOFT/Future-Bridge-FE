      ...
      <div className="container mx-auto px-6">
        <nav className="flex justify-center space-x-6 md:space-x-8 overflow-x-auto whitespace-nowrap">
          {allMenuItems.map((item, index) => {
            const target = item.isMenuLinkExternal ? "_blank" : item.menuTarget || "_self";
            const rel = item.isMenuLinkExternal ? "noopener noreferrer" : undefined;
            ...
            const isInternalPageLink = !item.isMenuLinkExternal && linkHref.startsWith("/");
