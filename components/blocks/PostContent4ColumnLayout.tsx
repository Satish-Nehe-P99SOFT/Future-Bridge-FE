...
import type { PostContent4ColumnLayoutBlock, ColumnLayoutItem } from "@/types/blocks";
...
const PostContent4ColumnLayout: React.FC<PostContent4ColumnLayoutProps> = ({ block }) => {
