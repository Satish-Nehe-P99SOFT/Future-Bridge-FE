...
const ImageAndTextBlockComponent: React.FC<ImageAndTextBlockProps> = ({ block }) => {
  ...
  return (
    ...
    >
      <div className="md:w-1/2">
        {block.heading && <h3 className="text-2xl font-semibold mb-4">{block.heading}</h3>}
        {block.description && (
          <div
      ...
      <div className="md:w-1/2 relative" style={{ minHeight: "300px" }}>
        ...
        {imageUrl && (
          <Image
            src={imageUrl}
            alt={imageAttributes?.alternativeText || block.heading || "Section image"}
            fill
